...
Same as Max Consecutive Ones III with k=1, but subtract 1 for the mandatory deletion.
...
FUNCTION longestSubarray(nums):
    ...
    FOR right ← 0 TO n - 1:
        ...
        WHILE zeros > 1:
            ...
            left += 1
        maxLen = MAX(maxLen, right - left)    // -1 because we must delete one
...
> Sliding window allowing at most 1 zero. Window size = `right - left + 1`, but answer = `right - left` because one element must be deleted.
